...
--Custom tags go here style is "Steamid", "silkicon.png", Color(xxx,xxx,xxx)/HexColor("#XXXXXX")/DR.Colors.Name, "Tag", nil
--Only ones that needs to stay is arizard and tarkus, make your own for your favourite staff or players
