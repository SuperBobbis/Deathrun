...
--	Default values placed here
--	Turq = HexColor("#1abc9c")
--	Clouds = HexColor("#E9F2F9")
--	RunnerTeam = HexColor( "#3fadff" )


DR.Colors = {
	DeathTeam = HexColor( "#911911" ),
	RunnerTeam = HexColor( "#25208A" ),
	Clouds = HexColor("#e6e7cf"),
	Silver = HexColor("#bdc3c7"),
	Concrete = HexColor("#95a5a6"),
	Alizarin = HexColor("#e74c3c"),
	Peter = HexColor("#3498db"),
	Turq = HexColor("#60003f"),
...
function DR:SetMainColor( col )
	DR.Colors.DarkBlue = col
end

function DR:SetMainTextColor( col )
	DR.Colors.Text.DarkBlue = col
end
